...
parser.add_argument(
    "--checkpoint", type=str, default="./ckpt/sam_med3d.pth"
)  # save checkpoint
...
class BaseTrainer:
    def __init__(self, model, dataloaders, args):
        ...
        self.init_checkpoint(
            join(self.args.work_dir, self.args.task_name, "sam_med3d_initial.pth")
        )  # pth load
    ...
    def unfreeze_layers(self):
        layers_to_unfreeze = max(
            len(self.model.image_encoder.blocks) + self.current_unfreeze_layer, 0
        )
    ...
    def set_optimizer(self):
        ...
        params_to_optimize = [
            ...
            {
                "params": [
                    p for p in model.prompt_encoder.parameters() if p.requires_grad
                ],
                "lr": self.args.lr * 0.1,
            },
            {
