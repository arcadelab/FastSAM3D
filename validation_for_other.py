...
import torch
# from originalSAM.segment_anything.build_sam import sam_model_registry3D
from segment_anything.utils.transforms3D import ResizeLongestSide3D
from SAMMed2D.segment_anything.build_sam import sam_model_registry
...
parser.add_argument('-cp', '--checkpoint_path', type=str, default='ckpt/sammed2d.pth')
...
def finetune_model_predict2D(img3D, gt3D, sam_model_tune, target_size=256, click_method='random', device='cuda', num_clicks=1, prev_masks=None):
    ...
    return pred_list, click_points, click_labels, iou_list, dice_list, times
    ...
    for batch_data in tqdm(test_dataloader):
        ...
        if(os.path.exists(pred_path)):
            ...
            if(args.dim==3):
                ...
                seg_mask_list, points, labels, iou_list, dice_list,times = finetune_model_predict2D(
