...
parser.add_argument('--data_train_path', type=str, default='./data/train', help='Path to the teacher encoder to generate logits')
...
if __name__ == "__main__":    
    ...
    all_dataset_paths = glob(join(args.data_train_path))
