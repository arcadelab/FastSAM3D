...
parser.add_argument(
    ...
    "--vis_path",
    type=str,
    default="/content/drive/MyDrive/paper_visual_results/totalseg0441/med_sam_2d",
)
parser.add_argument(
    "-cp",
    "--checkpoint_path",
...
parser.add_argument(
    ...
    "--save_name",
    type=str,
    default="/content/drive/MyDrive/paper_visual_results/totalseg2d.py",
)
...
def finetune_model_predict2D(
    ...
    )  # 1 channel -> 3 channel (align to RG)
    click_points = []
    click_labels = []
    dt = 0
    t = 0
    for slice_idx in tqdm(range(img3D.size(-1)), desc="transverse slices", leave=False):
        ...
        for iter in range(num_clicks):
            ...
            prev_masks, low_res_masks, iou_predictions, decodetime = (
