        ...
        for path in paths:
            ...
            if os.path.exists(d):
                for name in os.listdir(d):
                    ...
                    print(
                        f"Found {len(self.image_paths)} image(s) and {len(self.label_paths)} label(s)"
                    )
            ...
            for dt in ["Tr", "Val", "Ts"]:
                ...
                if os.path.exists(d):
                    for name in os.listdir(d):
                        ...
                        self.image_paths.append(
                            os.path.join(path, f"images{dt}", f"{base}.nii.gz")
                        )
                        self.label_paths.append(label_path)
    ...
    def _set_file_paths(self):
        ...
        for i in ima:
            ...
            self.label_paths.append(
                self.label_path + "/" + i.replace("images", "label")
            )
