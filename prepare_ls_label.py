...
from segment_anything.build_ls_sam3d import sam_model_registry3D # 
...
parser.add_argument('--data_validation_path', type=str, default='data/initial_train_dataset', help='Path to the validation data')
parser.add_argument('--label_path_base', type=str, default='./data/ttrain/label', help='Base path for saving labels')
parser.add_argument('--train_path_base', type=str, default='./data/ttrain/images', help='Base path for saving training images')
